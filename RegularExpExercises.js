...
let validity1 = validEmail(myEmailString);
console.log(`Valid email: ${validity1}`);

//2. Write a function to find the index of the first character of a valid URL

let myUrlString = "more info can be found at https://www.service.nsw.gov.au";

function validUrl (Url){
   return URL_REGEX.test(Url)
}
let validity2 = validUrl(myUrlString);
console.log(`Contains valid URL: ${validity2}`);
